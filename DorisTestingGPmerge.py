...
def checkout_button():
    ...
    if cartExists:
        ...
        CTkMessagebox(title="Error", message="No items in cart", icon="warning", option_1="Back",width=250, height=80, button_width=25,
                      button_height=75)
...
def get_image():
    try:
        ...
        # output = Image.open('resources/Final_logo_DEPRECIATED.jpg')
        output = logo
        return output
