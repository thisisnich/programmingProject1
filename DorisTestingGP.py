...
def sub_button():
    ...
    # if it is 0 then print 'cant go below 0' and dont reduce by 1
        ...
        CTkMessagebox(title="Error", message="Can't go below 0!", icon="cancel",width=350, height=100, button_width=25, button_height=75)  ###ADD
...
paymentFrame.grid_rowconfigure((0,1,2), weight=1)
